...
def tokenID(address, chain_id):
    ...
    r = requests.get('https://api.covalenthq.com/v1/'+chain_id+'/tokens/'+address +
                     '/nft_token_ids/?quote-currency=USD&format=JSON&key=ckey_ec93e26420d24cab8b09ef796f4')
...
def metadata(address, chain_id, token_id):
    ...
    r = requests.get('https://api.covalenthq.com/v1/'+chain_id+'/tokens/'+address+'/nft_metadata/' +
                     token_id+'/?quote-currency=USD&format=JSON&key=ckey_ec93e26420d24cab8b09ef796f4')
